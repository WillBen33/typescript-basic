 ...
 */
// x = 42; // error TS2322: Type 'number' is not assignable to type 'string'.
/**
...
// let zz: number;
// zz = 41;
// zz = "abc"; // error TS2322: Type 'string' is not assignable to type 'number'.
//== SIMPLE ARRAYS ==//
/**
...
let aa = [];
// aa.push(33);
// aa.push("abc"); // error TS2345: Argument of type 'string' is not assignable to parameter of type 'number'.
/**
